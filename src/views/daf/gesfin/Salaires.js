  ...
  return (
    <>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={5}>
              ...
              <div className="small text-medium-emphasis">Nouveau/User</div>
            </CCol>
          </CRow>
          <CRow>
            <CCol>
                ...
                <CCol xs={12}>
                  <CButtonToolbar role="group" aria-label="Toolbar with button groups">
                    <CButtonGroup className="me-2" role="group" aria-label="First group">
                      <CButton color="success">Valider</CButton>
                    </CButtonGroup>
                    <CButtonGroup className="me-2" role="group" aria-label="Second group">
                      <CButton color="secondary">Annuler</CButton>
                    </CButtonGroup>
      ...
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            <CCardHeader>Liste des Slaires</CCardHeader>
            <CCardBody>
              <CRow>
                  ...
                  <CRow>
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-info py-1 px-3">
                        <div className="text-medium-emphasis small">Cadre Sup.</div>
                        <div className="fs-5 fw-semibold">9,123</div>
                      </div>
                    </CCol>
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-danger py-1 px-3 mb-3">
                        <div className="text-medium-emphasis small">Cadres</div>
                  ...
                  <CRow>
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-warning py-1 px-3 mb-3">
                        <div className="text-medium-emphasis small">Agents Maîtrise</div>
                        <div className="fs-5 fw-semibold">78,623</div>
                      </div>
                    </CCol>
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-success py-1 px-3 mb-3">
                        <div className="text-medium-emphasis small">Exécutants</div>
